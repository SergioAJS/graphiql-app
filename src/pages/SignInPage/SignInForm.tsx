    ...
    <>
      <div className="relative flex h-full w-full grow flex-wrap items-center justify-center">
        <img
          ...
          alt="form_background"
        />
        <div className="relative mx-auto mb-5 mt-20 w-full max-w-md rounded-xl border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
