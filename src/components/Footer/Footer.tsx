...
export const Footer = () => {
  return (
    <footer className="flex w-full items-center justify-between gap-5 border-t-2 bg-white px-10 py-6 font-medium">
      ...
      <div className="flex w-1/3 flex-col gap-5 self-end">
        <a
